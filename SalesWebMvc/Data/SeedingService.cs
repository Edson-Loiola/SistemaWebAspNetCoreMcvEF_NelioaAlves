...
{
    public class SeedingService //quando o SeedingService for criado, receberá uma instancia do Context
    {
        ...
        //operacao responsavel por polular a base de dados
        public void Seed()
        {

            // a operação any do linq verfica se já existe algum dado nessa tabela
            ...
            //efetivar essa operação (salva e confimar a operção no BD).
